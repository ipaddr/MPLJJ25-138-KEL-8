...
class _HomePagePState extends State<HomePageP> {
  ...
  String _userName = "Pesantren"; // Default name
      ...
      child: Column(
        children: [
              ...
              ElevatedButton(
                onPressed: () {
                  ...
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => const DistribusiPageP(),
                    ),
                  );
                },
          ...
          Row(
            ...
            children: [
              _buildStatusItem(context, 'assets/img4.png', 'Berhasil'),
              _buildStatusItem(context, 'assets/img5.png', 'Tertunda'),
              _buildStatusItem(
                context,
                'assets/img7.png',
                'Gagal',
              ...
              _buildStatusItem(context, 'assets/img6.png', 'Jumlah Penerima'),
            ],
          ),
        ],
      ),
